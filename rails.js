...
const railData = {
    "1.KATO ユニトラック(N)": {
        ...
        "1.2.複線・複線カント付レール": [
            { name: "WS248", type: "straight", length: 248, std: "KATO_N", isDouble: true, width: 33, desc: "複線直線 248mm" },
            { name: "WR315/282-45", type: "curve", radius: 282, angle: 45, std: "KATO_N", isDouble: true, width: 33, desc: "複線カント曲線" }
        ],
        "1.3.高架": [],
        "1.4.ポイント": [
            { name: "EP718-15L", type: "point", length: 248, joints: 3, angle: 15, std: "KATO_N", desc: "6番ポイント左" }
        ],
        "1.5.その他(一部複線含む)": [
